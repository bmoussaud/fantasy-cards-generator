...
| --- | --- | --- | --- |
| Gandalf | Lead / Architect | review | Azure solution architecture, Azure AI Foundry service design (models, agents, prompt flows), techni… |
| Legolas | Frontend Dev | edit | Web UI (React or the project's chosen framework), UX, client-side integration with Azure AI Foundry… |
| Aragorn | Backend Dev | advisory | Server-side APIs, Azure AI Foundry SDK/service integration (models, agents, evaluation), business l… |
| Gimli | DevOps / Infra | edit | Azure deployment (App Service / Container Apps / AKS), Infrastructure as Code (Bicep/Terraform), CI… |
| Samwise | Tester | review, edit | Test strategy, unit/integration/e2e testing, edge cases around AI service responses (latency, failu… |
...
Lead / Architect, Frontend Dev, Backend Dev, DevOps / Infra, Tester, RAI Reviewer, Fact Checker
...
- **Can:** review code and pull requests; write and run tests; security and secrets review; responsible-AI and content-safety review; author and maintain CI/CD workflows; UX and visual design; deploy to live environments
- **Cannot (no agent claims this):** write and modify code; write and maintain documentation; cut releases and publish packages
